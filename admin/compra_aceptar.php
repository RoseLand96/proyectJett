...
<?php ActualizacionEstadoCarrito($_GET["recordID"],1);?>
                 ...
                 <?php
				 $contenido = 'Hola xxxxxxx;<br><br><p>Tu Compra ha sido aceptada. Continuaremos en el proceso de tu pedido y la entrega sera realizada en el plazo que te informamos al finalizar tu compra.</p>';
				 	 $asunto = 'Compra enviada en buyo.com';
