...
if (isset($_POST['Email'])) {
  ...
  $MM_redirectLoginSuccess = "ver_producto.php";
  $MM_redirectLoginFailed = "acceso_error.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_connectionBuyo, $connectionBuyo);
  
  $LoginRS__query=sprintf("SELECT ID_usuario, Email, Password FROM usuario WHERE Email=%s AND Password=%s",
  ...
  <div class="subcontenedor">
    ...
    <div class="content">
                ...
                <form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
                 <h2>Accede a la Pagina con tus Datos:</h2>
                  
                    <span id="sprytextfield1">
                    <input type="text" placeholder="&#128231;   E-Mail" name="Email" id="textfield2" />
                    ...
                    <input type="password" placeholder="&#128272;   Password" name="Password" id="textfield3" />
