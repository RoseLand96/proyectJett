...
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
  ...
  $deleteSQL = sprintf("DELETE FROM carrito WHERE ID_usuario=%s AND 	intTransaccionEfectuada=0",
...
<div class="container">
  ...
  <div class="subcontenedor">
    ...
    <div class="content">
                ...
                <!-- InstanceBeginEditable name="EditRegion4" -->Carrito eliminado: <a href="carrito_lista.php">Vuelva a su carrito</a><!-- InstanceEndEditable -->
      <!-- end .content --></div>
